...
void TInfiniteWireZ::BFeld(long double x,long double y,long double z, long double B[4][4]){
...
void TInfiniteWireZCenter::BFeld(const long double x, const long double y, const long double z, long double B[4][4]){
...
// defined by two position vectors (SW1x,SW1y,SW1z and SW2x,SW2y,SW2z) lying on the ends of the straight wire 
// code generated by Maple ("FiniteWireDiffs.mw") with formula http://de.wikipedia.org/wiki/Biot-Savart#Gerader_Linienleiter
void TFiniteWire::BFeld(const long double x, const long double y, const long double z, long double B[4][4])
{
...
void TFiniteWireZ::BFeld(const long double x, const long double y, const long double z, long double B[4][4])
{
	long double vorfaktor = mu0 * I_rt / (4 * pi);
...
void TFiniteWireX::BFeld(const long double x, const long double y, const long double z, long double B[4][4])
{
	long double vorfaktor = mu0 * I_rt / (4 * pi);
...
void TFiniteWireY::BFeld(const long double x, const long double y, const long double z, long double B[4][4])
{
	long double vorfaktor = mu0 * I_rt / (4 * pi);
...
void TFullRacetrack::BFeld(long double x, long double y, long double z, long double B[4][4]){
	long double vorfaktor = mu0 * I_rt / (4 * pi);
...
void TFiniteWireZCenter::BFeld(const long double x, const long double y, const long double z, long double B[4][4]){
	long double vorfaktor = mu0 * I_rt / (4 * pi);
