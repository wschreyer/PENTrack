...
long double TBFIntegrator::Integrate(double x1, double y1[6], double dy1dx[6], double B1[4][4], double E1[3], double dE1[3][3], 
	...
	if (B1[3][0] == 0 && B2[3][0] == 0)
		throw std::invalid_argument("To Whom it may concern; You are trying to bruteforce spintrack a particle in a reigon with 0 BField. PENTRack no understand 0 field. Check your boundaries so they make sense!");
